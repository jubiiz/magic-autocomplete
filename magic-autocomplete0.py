...
def vectorize(known_cards):
    ...
    for card in known_cards:
        try:
            ...
            print("WARNING: CARD '{v}' NOT FOUND.\
...
def main():
    ...
    model = tf.keras.models.load_model("lstm_models/m5.h5")
