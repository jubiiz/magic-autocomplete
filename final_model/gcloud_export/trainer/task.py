...
from utils import load_decklists, load_f_decks_from_bucket, train_test_val_split, get_aug_inputs_and_labels, TrainTestValData
...
def main():
    ...
    history = compile_and_fit(model, all_data, epochs=args.num_epochs,
                              batch_size=args.batch_size, checkpoint_filepath=os.path.join(output_directory, 'checkpoints'))
    #model.summary()
